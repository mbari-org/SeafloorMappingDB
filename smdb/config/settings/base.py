...
MIGRATION_MODULES = {"sites": "smdb.contrib.sites.migrations"}
...
MIDDLEWARE = [
    ...
    # "django.middleware.common.BrokenLinkEmailsMiddleware", # https://stackoverflow.com/a/62104781/1281657
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "smdb.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Mike McCann""", "mccann@mbari.org")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "smdb.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "smdb.users.adapters.SocialAccountAdapter"
# django-compressor
# ------------------------------------------------------------------------------
