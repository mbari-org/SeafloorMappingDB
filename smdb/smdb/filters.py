...
class MissionFilter(FilterSet):
    ...
    def filter_queryset(self, queryset):
        ...
        # Handle vehicle_name filter separately to handle None values (PR5)
        vehicle_name_values = self.data.getlist('vehicle_name', [])
        
        # Create a copy of data without name, expedition__name, and vehicle_name fields to avoid double filtering
        ...
        # Parent filter_queryset uses form.cleaned_data; ensure form is validated first
        base_filterset.form.is_valid()
