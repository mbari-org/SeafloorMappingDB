...
class Expedition(
    ...
    investigator = models.ForeignKey(Person, blank=True, null=True, related_name='investigator', on_delete=models.CASCADE)
...
class Compilation(
    ...
    grid_bounds = models.PolygonField(srid=4326, spatial_index=True, blank=True, null=True)
...
class Mission(
    ...
    startdate = models.DateTimeField(null=True)
    enddate = models.DateTimeField(null=True)
    startpoint = models.PointField(srid=4326, spatial_index=True, dim=2, blank=True, null=True)
