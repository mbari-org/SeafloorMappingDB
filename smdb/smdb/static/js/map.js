...
mapboxgl.accessToken = 'pk.eyJ1Ijoic2FsYW15IiwiYSI6ImNrZjRlMGVpczBjNHgzMHZ3bWpmZWtsazcifQ.oR-gObeinElgR2KXLOYeWQ';
const map = L.map("map");
const media_url = JSON.parse(document.getElementById("MEDIA-URL").textContent);
const options = { minZoom: 1, maxNativeZoom: 13, maxZoom: 16, exclusiveGroups: ["Base Maps   &#127758; "], groupCheckboxes: true };
...
const esriOceans = L.esri.Vector.vectorBasemapLayer("ArcGIS:Oceans", { 
  apikey: "AAPK4f2bc64881714cb2b03b1b5798dd2b740wn2YfXp7EZuoC_GggsJw92b06Ou-ZhL1i0CU-haX0JwKr9Ve9ned4wNTOYlGu1x"
}, options);
/* 
...
const openMapStreetViewLayer = L.esri.Vector.vectorBasemapLayer("OSM:Standard", { 
  apikey: "AAPK4f2bc64881714cb2b03b1b5798dd2b740wn2YfXp7EZuoC_GggsJw92b06Ou-ZhL1i0CU-haX0JwKr9Ve9ned4wNTOYlGu1x"
}, options);

// ArcGIS_Dark_Vector_Layer
const arcGISDark = L.esri.Vector.vectorBasemapLayer("ArcGIS:DarkGray", { 
  apikey: "AAPK4f2bc64881714cb2b03b1b5798dd2b740wn2YfXp7EZuoC_GggsJw92b06Ou-ZhL1i0CU-haX0JwKr9Ve9ned4wNTOYlGu1x"
}, options);

// ArcGIS_Gray_Vector_Layer
const arcGISGray = L.esri.Vector.vectorBasemapLayer("ArcGIS:LightGray", { 
  apikey: "AAPK4f2bc64881714cb2b03b1b5798dd2b740wn2YfXp7EZuoC_GggsJw92b06Ou-ZhL1i0CU-haX0JwKr9Ve9ned4wNTOYlGu1x"
}, options);
...
let feature = L.geoJSON(missions, {
  ...
  .bindTooltip(function (layer) {
    ...
    if ((browserName = "firefox") || (browserName = "safari")) {
      dateOfMission = dateOfMission.replace(/(\d{4})(\d{2})(\d{2})/g, '$1-$2-$3T00:00:00');
    } else {
      dateOfMission = dateOfMission.replace(/(\d{4})(\d{2})(\d{2})/g, '$2-$3-$1');
    }

    dateOfMission = new Date(dateOfMission).toLocaleDateString('en-us', { weekday: "long", year: "numeric", month: "short", day: "numeric" });
...
mousePosition.onAdd = function (map) {
  ...
  mousePos.innerHTML = `&nbsp&nbsp${e.latlng.lat.toFixed(4)},  ${e.latlng.lng.toFixed(4)}&nbsp&nbsp`;
  });
  return mousePos;
};
...
var controlLayers = L.control.groupedLayers(mapBaseLayers, groupedOverlays, options);
