...
const FilterControl = L.Control.extend({
  onAdd: function (map) {
    ...
    optionCompilation.selected = true;
    ...
    const copyForm = function (filterType = "compilation") {
    ...
    // Current filter type (default to compilation)
    let currentFilterType = "compilation";
